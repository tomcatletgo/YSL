...
import tag.vo.easyui.Autocomplete;
...
public class CommonController extends BaseController {
	...
	public ModelAndView openViewFile(HttpServletRequest request) {
		...
		String subclassname = oConvertUtils.getString(request.getParameter("subclassname"), "ycw.system.pojo.base.TSAttachment");
	 ...
	 * @return
	 */
	@RequestMapping(params = "viewFileFtp")
	public void viewFileFtp(HttpServletRequest request, HttpServletResponse response) {
		String fileid =oConvertUtils.getString(request.getParameter("fileid"));
		String subclassname = oConvertUtils.getString(request.getParameter("subclassname"), "ycw.driver.entity.TBFtpFile");
		Class fileClass = MyClassLoader.getClassByScn(subclassname);// 附件的实际类
		Object fileobj = systemService.getEntity(fileClass, fileid);
		
		UploadFileFtp uploadFile = new UploadFileFtp(request, response);
		uploadFile.setObject(fileobj);
		uploadFile.setView(true);
		systemService.viewOrDownloadFileFtp(uploadFile);
	}
	
	@RequestMapping(params = "downloadFileFtp")
	public void downloadFileFtp(HttpServletRequest request, HttpServletResponse response) {
		String fileid =oConvertUtils.getString(request.getParameter("fileid"));
		String subclassname = oConvertUtils.getString(request.getParameter("subclassname"), "ycw.driver.entity.TBFtpFile");
		Class fileClass = MyClassLoader.getClassByScn(subclassname);// 附件的实际类
		Object fileobj = systemService.getEntity(fileClass, fileid);
