...
public abstract class PoiExcelHelper {
    ...
    /** 获取sheet列表，子类必须实现 */
    public abstract ArrayList<String> getSheetList(InputStream is);
    ...
    /** 读取Excel文件数据，子类必须实现 */
    public abstract ArrayList<ArrayList<String>> readExcel(InputStream is, int sheetIndex, String rows, String columns);
    ...
    /** 读取Excel文件数据，子类必须实现 */
    public abstract ArrayList<ArrayList<String>> readExcel(InputStream is, int sheetIndex, String rows, int[] cols);
    ...
    protected ArrayList<ArrayList<String>> readExcel(Sheet sheet, String rows, int[] cols) {
        ...
        for (String rowStr : rowList) {
            if (rowStr.contains(CONNECTOR)) {
                ...
                if (!CollectionUtils.isEmpty(getRowsValue(sheet, start, end, cols))) {
