...
public class JeecgSqlUtil {
	...
	private static String getFlieTxt(String fileUrl) {
		core.util.LogUtil.info("---------------------------------------sql 路径 :"+fileUrl);
		String sql = null;
		try {
...
//		core.util.LogUtil.info(projectPath);
//		String projectPath =  request.getSession().getServletContext().getRealPath("/");
	...
	public static String getAppPath(Class cls) {
		...
		core.util.LogUtil.info("realPath----->"+realPath);
		return realPath;
	}
	...
	public static void main(String[] args) {
		//core.util.LogUtil.info(getAppPath(JeecgSqlUtil.class));
		core.util.LogUtil.info(getCountSqlBySql("SELECT * 	from JEECG_DICT_PARAM WHERE 1=1"));
	}
