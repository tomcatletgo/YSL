...
public class ResourceUtil {
    ...
    public static final List<TSRoleUser> getUserRoleList(){
    	HttpSession session = ContextHolderUtils.getSession();
    	if (ClientManager.getInstance().getClient(session.getId()) != null) {
    ...
    public static final boolean isUserAdmin() {
    	List<TSRoleUser> userRoleList = ResourceUtil.getUserRoleList();
    	for (TSRoleUser ru : userRoleList) {
	...
	core.util.LogUtil.info(getPorjectPath());
	core.util.LogUtil.info(getSysPath());
